...
const Productpage = ({ id, name, description, price, imageUrl }) => {
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    let filteredProduk = searchData(dataFiltered, textSearch, "nmProduk");
    setData(filteredProduk);
  };
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((res) => {
        ...
        setDataFiltered(dataRes.products);
  ...
  useEffect(() => {
    if (textSearch.length === 0 && dataFiltered.length !== 0) {
    ...
    <LoadingComponent isLoading={isLoading}>
      <div className="container-news">
        <div className="d-flex info-mitra p-4 gap-4 align-items-center">
          <img
            src={isMitraHasFoto() && convertImageURL(profilMitra.foto_mitra)}
            alt="foto mitra"
          ...
          <div className="d-flex flex-column">
            <div className="d-flex align-items-center">
              <h3 className="text-white" style={{ fontSize: "35px" }}>
                {profilMitra && profilMitra.namaMitra}
              </h3>
              <div
                className="rounded-circle bg-white mx-3"
            ...
            <h5 className="text-white" style={{ fontSize: "25px" }}>
              {profilMitra && profilMitra.alamatMitra}
            </h5>
          </div>
