    ...
    <div className="container" style={{ paddingTop: '100px' }}>
      ...
      <div className="form-group">
        ...
        <div className="form-group">
          ...
          <textarea className="form-control" id="message" rows="4" value={pesan} onChange={(e) => setPesan(e.target.value)}></textarea>
        </div>
        <button onClick={handleContact} type="submit" className="btn btn-primary mt-3">Kirim Pesan</button>
      </form>
    </div>
  );
};
