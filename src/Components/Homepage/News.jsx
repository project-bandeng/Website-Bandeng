...
function NewsItem({ data }) {
  ...
  return (
    <div
      className="col-md-4 d-flex flex-column gap-3 my-2"
      style={{ height: "170px" }}
    >
      <div className="card rounded-3 h-100">
        <img
          src={data.foto_article ? convertImage(data.foto_article) : ""}
          alt="logo-mitra"
      ...
      <section className="news-section" style={{ backgroundColor: "#DDE6ED" }}>
        <div className="container-fluid">
          ...
          <p className="text-center">
            Berita terbaru terkait informasi Bandeng pada wilayah Krobokan Kota
            Semarang
          </p>
          <div
